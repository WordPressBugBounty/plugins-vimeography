...
= 2.4.9
* [Security] License updater: Enforce TLS verification and harden response validation on license server requests.

= 2.4.8
* [Fix] Harvestone theme : Fixing Video Redirect.

= 2.4.7
* [Fix] License management : Fix License Re-activation issue.

= 2.4.6
* [Fix] Video limit: Fix on the limitation of the number of videos to display in a gallery.
